...
public enum Mensaje {
	...
	if (mensaje.equals(PREFIJO+"BASE_DE_DATOS"))
	    return BASE_DE_DATOS;
	if (mensaje.equals(PREFIJO+"REGISTRO_AGREGADO"))
	    return REGISTRO_AGREGADO;
	if (mensaje.equals(PREFIJO+"REGISTRO_ELIMINADO"))
	    return REGISTRO_ELIMINADO;
	if (mensaje.equals(PREFIJO+"REGISTRO_MODIFICADO"))
	    return REGISTRO_MODIFICADO;
	if (mensaje.equals(PREFIJO+"DESCONECTAR"))
	    return DESCONECTAR;
	if (mensaje.equals(PREFIJO+"DETENER_SERVICIO"))
	    return DETENER_SERVICIO;
	if (mensaje.equals(PREFIJO+"ECO"))
	    return ECO;
	return INVALIDO;
    }
    ...
    public String toString() {
        // Aquí va su código.
	if (this.equals(BASE_DE_DATOS))
	    return PREFIJO+"BASE_DE_DATOS";
	if (this.equals(REGISTRO_AGREGADO))
	    return PREFIJO+"REGISTRO_AGREGADO";
	if (this.equals(REGISTRO_ELIMINADO))
	    return PREFIJO+"REGISTRO_ELIMINADO";
	if (this.equals(REGISTRO_MODIFICADO))
	    return PREFIJO+"REGISTRO_MODIFICADO";
	if (this.equals(DESCONECTAR))
	    return PREFIJO+"DESCONECTAR";
	if (this.equals(DETENER_SERVICIO))
